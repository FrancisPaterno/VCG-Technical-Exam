...
* Clone this repository `git clone https://github.com/doublej42/MyProject`

or you can use .NET Core CLI templates:

* Install the template from NuGet repository: `dotnet new -i MyProject`

* Initialize the project: `dotnet new MyProject -o MyProject`
